...
**Hiring Criteria for Product Security Engineers**
    1. **Software Development:** Candidates must have capabilities to fix vulnerabilities and build automations to reduce toil. Singh notes that at Rippling, they expect candidates at all levels to be "great at writing software."
    2. **Application Security (AppSec):** Strong AppSec skills are required. For Staff-level candidates, expertise in multiple areas within AppSec is expected.
    3. **Communication Skills:** Singh emphasizes that all successful ProdSec engineers must be able to influence others.
