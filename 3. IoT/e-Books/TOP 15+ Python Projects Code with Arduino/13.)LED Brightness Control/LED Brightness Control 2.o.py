...
# Pin number for LED brightness control (assuming it's connected to pin 9)
...
def control_led_brightness(pwm_value):
    pin9.write(pwm_value)  # PWM value between 0 (off) and 1 (full brightness)
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                print(f"Brightness: {distance}, PWM Value: {pwm_value}")
                control_led_brightness(pwm_value)
