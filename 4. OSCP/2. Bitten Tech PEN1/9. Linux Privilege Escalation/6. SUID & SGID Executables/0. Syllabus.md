...
[LAB] SUID Exploitation: Common Ways (Video – 08:09)

[LAB] SUID Exploitation: Shared Objects (Video – 08:40)

[LAB] SUID Exploitation: Environment Variables (Video – 11:23)

SUID Executables.pdf (PDF Document)

#### sudo exploitation

Introduction to SUDO (Video – 18:51)

[LAB] SUDO Exploitation: Escape Sequences (Video – 10:32)

[LAB] SUDO Exploitation: ld_preload (Video – 09:57)

[LAB] SUDO Exploitation: ld_library_path (Video – 08:27)

sudo.pdf (PDF Document)

#### Conclusion

Conclusion and What Next? (Video – 11:53)

Conclusion.pdf (PDF Document)
