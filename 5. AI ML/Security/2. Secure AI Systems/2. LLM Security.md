...
**How it works:** attacker iteratively queries the model and adjusts inputs so that outputs converge on realistic training samples — effectively reversing the learning process. This reconstructs **new, previously unknown text or attributes**.
