...
---
## Troubleshooting : If you don't get mouse inside VM 
...
## Install VMware Tools on Kali Linux | Fix Display, Drag & Drop

First update and upgrade the machine fully 
...
open-vm-tools : represents he core functionality of vm ware tools
open-vm-tools-desktop : represents the graphical user interface
