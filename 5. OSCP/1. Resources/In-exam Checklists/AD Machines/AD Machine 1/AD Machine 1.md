...
- [ ] For post exploitation dump all hashes using netexec and/or mimikatz.
- [ ] Check UDP ports.
...
- [ ] If you get completely stuck, you can manually check for things too. If that doesn't help you likely need to relearn the privesc attacks, and consider if privesc is even needed here.
