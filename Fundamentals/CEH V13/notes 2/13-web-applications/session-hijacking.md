...
- **[Cross-Site Scripting (XSS) Attack](owasp-top-10-threats.md#cross-site-scripting-xss)**
...
- Read more on [Cross-Site Scripting (XSS)](owasp-top-10-threats.md#cross-site-scripting-xss) and [CSRF](#cross-site-request-forgery-csrf)
